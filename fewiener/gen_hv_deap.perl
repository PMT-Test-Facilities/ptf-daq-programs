...
<html>
  ...
  <body>
	...
	<tr><th colspan=2>DEAP HV control</tr>
	<tr><td width="50%">
    ...
    <form name="form2" method="Get">
      ...
      <table border=1 cellpadding=2">
        ...
        <tr>
	  <td>
             <input type=button value=\"Main switch ON\" onClick=\"clearTimeout(reloadTimerId); ODBSet('/Equipment/deapmpod/Settings/mainSwitch', 1); window.location.reload();\"></input>
             <input type=button value=\"Main switch OFF\" onClick=\"clearTimeout(reloadTimerId); ODBSet('/Equipment/deapmpod/Settings/mainSwitch', 0); window.location.reload();\"></input>
          </td>
	  <td>
             <input type=button value=\"Output ON\" onClick=\"clearTimeout(reloadTimerId); ODBSet('/Equipment/deapmpod/Settings/outputEnable', 1); window.location.reload();\"></input>
             <input type=button value=\"Output OFF\" onClick=\"clearTimeout(reloadTimerId); ODBSet('/Equipment/deapmpod/Settings/outputEnable', 0); window.location.reload();\"></input>
          </td>
        </tr>
      </table>
      <hr>
...
sub outputGroup
  {
	...
	$tr .= "<td align=left><input type=button value=\"on\" onClick=\"clearTimeout(reloadTimerId); ODBSet('/Equipment/deapmpod/Settings/outputSwitch[$k]', 1); window.location.reload();\"></input><input type=button value=\"off\" onClick=\";clearTimeout(reloadTimerId); ODBSet('/Equipment/deapmpod/Settings/outputSwitch[$k]', 0); window.location.reload();\"></input></td>\n";
