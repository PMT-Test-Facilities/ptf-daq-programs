...
//----------------------------------------------------------
TPathCalculator::TPathCalculator(double tankCentreXPos, double tankCentreYPos, double tankRadius,
...
//----------------------------------------------------------
void TPathCalculator::InitialiseOpticalBoxes(XYPolygon points0_lo, XYPolygon points0_up, XYPolygon points1_lo,
                                             XYPolygon points1_up, int z0_lo, int z0_up, int z1_lo, int z1_up) {
//----------------------------------------------------------
...
//----------------------------------------------------------
bool TPathCalculator::CalculatePath(XYPoint start, XYPoint end, std::vector <XYPoint> &path,
...
//----------------------------------------------------------
void TPathCalculator::CreatePath(double startX, double startY, double endX, double endY, std::vector <XYPoint> &path,
                                 bool xFirst, bool simplePath) {
//----------------------------------------------------------
...
//----------------------------------------------------------
bool TPathCalculator::CheckPathForCollisions(BoostPolygon *objectMoving, BoostPolygon *objectStationary,
                                             std::vector <XYPoint> &path, bool tank_height_start,
                                             bool tank_height_end) {
//----------------------------------------------------------
