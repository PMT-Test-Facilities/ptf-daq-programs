...
def SpatialData(e):
    ...
    for index, spatialData in enumerate(e.spatialData):
        ...
        if len(spatialData.Acceleration) > 0:
            total = math.sqrt(spatialData.Acceleration[0]*spatialData.Acceleration[0]+spatialData.Acceleration[1]*spatialData.Acceleration[1]+
                              spatialData.Acceleration[2]*spatialData.Acceleration[2])
            print("Acceleration> x: %6f  y: %6f  z: %6f, total: %6f" % (spatialData.Acceleration[0], spatialData.Acceleration[1], spatialData.Acceleration[2], total))
        ...
        if len(spatialData.MagneticField) > 0:
            total = math.sqrt(spatialData.MagneticField[0]*spatialData.MagneticField[0] + spatialData.MagneticField[1]*spatialData.MagneticField[1]+
                              spatialData.MagneticField[2]*spatialData.MagneticField[2])
            print("Magnetic Field> x: %6f  y: %6f  z: %6f, total: %6f" % (spatialData.MagneticField[0], spatialData.MagneticField[1], spatialData.MagneticField[2],total))
